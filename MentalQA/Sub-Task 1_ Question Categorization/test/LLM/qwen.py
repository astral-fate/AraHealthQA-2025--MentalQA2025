...
MODEL_NAME = "qwen/qwen3-235b-a22b" # MODIFIED for Qwen model
...
def get_prediction_from_nvidia_api(client, question, all_labels, model_name):
    """Gets a multi-label prediction from the NVIDIA API, modified for Qwen."""
    full_prompt = build_prompt(question)
    full_response_content = ""
    
    try:
        # MODIFIED: Added extra_body for Qwen model
